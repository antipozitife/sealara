...
В нём доступны главная страница и справочник заболеваний с детальными карточками. Серверные разделы остаются
гостевыми, а проверка сессии не отправляет запрос к отсутствующему API.
