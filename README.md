<div align="center">
  ...
  ![Модель](https://img.shields.io/badge/модель-случайный_лес-c0529c?style=for-the-badge)
  ...
  **Адаптивный интерфейс · строгая типизация · машинное обучение · тесты · контейнеризация**
  ...
  [![Открыть Sealara](https://img.shields.io/badge/ОТКРЫТЬ_ПРИЛОЖЕНИЕ-sealara.vercel.app-7b1f9f?style=for-the-badge&logo=vercel&logoColor=white)](https://sealara.vercel.app/)
</div>

> **Важно:** Sealara — учебный проект и система поддержки принятия решений. Результаты не являются медицинским диагнозом и не заменяют консультацию врача.
...
<div align="center">
  ...
  <a href="#проверки-и-качество">Качество</a> •
  <a href="#что-проект-демонстрирует-работодателю">Для работодателя</a>
</div>
...
<a href="https://sealara.vercel.app/">
  <img src="./docs/screenshots/glavnaya.webp" alt="Главная страница Sealara" />
</a>

<p align="center">
  <sub>Главная страница — знакомство с сервисом и переход к диагностике</sub>
</p>

<table>
  <tr>
    <td width="50%" valign="top">
      <img src="./docs/screenshots/enciklopediya.webp" alt="Энциклопедия заболеваний Sealara" />
      <br />
      <sub><strong>Энциклопедия заболеваний</strong><br />Поиск и информативные карточки из базы Sealara</sub>
    </td>
    <td width="50%" valign="top">
      <img src="./docs/screenshots/avtorizaciya.webp" alt="Экран авторизации Sealara" />
      <br />
      <sub><strong>Авторизация</strong><br />Единая форма входа и регистрации пользователя</sub>
    </td>
  </tr>
</table>

> Все экраны можно посмотреть в работающем приложении: **[sealara.vercel.app](https://sealara.vercel.app/)**.
...
Готовая клиентская версия опубликована на Vercel:

### [Открыть Sealara онлайн →](https://sealara.vercel.app/)

Для полноценной диагностики локально потребуются сервер, база данных и сервис машинного обучения.
